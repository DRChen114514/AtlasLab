...
当前真题质量基准为 `runs/huazhong-2026-a-quality-v6-20260727`，使用
`C:\Users\lwh86\Downloads\A题：城市绿色物流配送调度_1776993150913`
中的题面和四个附件，并与 `C:\Users\lwh86\Desktop\华中杯\2026\A` 中 8 篇获奖论文进行了对比。
